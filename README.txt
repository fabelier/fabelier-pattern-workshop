...
If you want to help out with the development of Pattern, take a look at the sentiment.csv sheet:
https://docs.google.com/folder/d/0Bz59SEXKdzxIVUdQY0Y3SHZ1dXM/edit

Add a column and provide a score (between -1.0 and +1.0) for each word. A negative score means that you think this word has a negative tone (e.g., terrible). A positive score means that you think this word has a positive tone (e.g., heureux). You can download the .csv and plug it in to the 5-annotation.py script.
